...
void
ni_ifconfig_add_meta_data_to_node(xml_node_t *root, ni_client_state_config_t *conf)
{
...
ni_bool_t
ni_ifconfig_get_meta_data_from_node(ni_client_state_config_t *conf, xml_node_t *root)
{
