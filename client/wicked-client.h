...
extern int			ni_call_device_change_xml(ni_dbus_object_t *, xml_node_t *, ni_objectmodel_callback_info_t **,
					ni_call_error_handler_t *);
extern int			ni_call_device_delete(ni_dbus_object_t *, ni_objectmodel_callback_info_t **);

extern int			ni_call_firewall_up_xml(ni_dbus_object_t *, xml_node_t *, ni_objectmodel_callback_info_t **);
extern int			ni_call_firewall_down_xml(ni_dbus_object_t *, ni_objectmodel_callback_info_t **);
extern int			ni_call_link_up_xml(ni_dbus_object_t *, xml_node_t *, ni_objectmodel_callback_info_t **);
extern int			ni_call_link_login_xml(ni_dbus_object_t *, xml_node_t *, ni_objectmodel_callback_info_t **,
					ni_call_error_handler_t *);
extern int			ni_call_link_logout_xml(ni_dbus_object_t *, xml_node_t *, ni_objectmodel_callback_info_t **,
					ni_call_error_handler_t *);
extern int			ni_call_link_change_xml(ni_dbus_object_t *, xml_node_t *, ni_objectmodel_callback_info_t **,
					ni_call_error_handler_t *);
extern int			ni_call_link_down(ni_dbus_object_t *, ni_objectmodel_callback_info_t **);

extern int			ni_call_request_lease(ni_dbus_object_t *object, const ni_dbus_service_t *service,
					ni_dbus_variant_t *arg, ni_objectmodel_callback_info_t **callback_list);
extern int			ni_call_request_lease_xml(ni_dbus_object_t *, const ni_dbus_service_t *,
					xml_node_t *, ni_objectmodel_callback_info_t **);
extern int			ni_call_drop_lease(ni_dbus_object_t *object, const ni_dbus_service_t *service,
