...
extern int		ni_system_macvlan_create(ni_netconfig_t *nc, const char *ifname,
				const ni_macvlan_t *cfg_macvlan, ni_netdev_t **ifpp);
extern int		ni_system_macvlan_delete(ni_netdev_t *ifp);
