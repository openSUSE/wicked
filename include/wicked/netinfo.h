...
extern const ni_string_array_t *ni_config_sources(const char *type);
...
extern xml_document_t *	ni_netconfig_firmware_discovery(const char *, const char *, const char *);
