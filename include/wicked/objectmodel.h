...
#define NI_OBJECTMODEL_VXLAN_INTERFACE		NI_OBJECTMODEL_INTERFACE ".VXLAN"
#define NI_OBJECTMODEL_IPVLAN_INTERFACE		NI_OBJECTMODEL_INTERFACE ".IPVLAN"
#define NI_OBJECTMODEL_IPVTAP_INTERFACE		NI_OBJECTMODEL_INTERFACE ".IPVTAP"
