...
extern dbus_bool_t		ni_objectmodel_netif_ifstate_to_dict(const ni_ifstate_t *, ni_dbus_variant_t *);
extern dbus_bool_t		ni_objectmodel_netif_ifstate_from_dict(ni_ifstate_t *, const ni_dbus_variant_t *);
