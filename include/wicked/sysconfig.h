...
extern void		ni_sysconfig_set(ni_sysconfig_t *, const char *name, const char *variable);
extern void		ni_sysconfig_set_integer(ni_sysconfig_t *, const char *name, unsigned int);
extern void		ni_sysconfig_set_boolean(ni_sysconfig_t *, const char *name, int);
