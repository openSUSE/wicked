...
#define SIT_UINT16_PROPERTY(dbus_type, type, rw) \
	NI_DBUS_GENERIC_UINT16_PROPERTY(sit, dbus_type, type, rw)
...
static const ni_dbus_property_t	ni_objectmodel_sit_property_table[] = {
	...
	SIT_UINT16_PROPERTY(ttl, ttl, RO),
	SIT_UINT16_PROPERTY(tos, tos, RO),
	SIT_BOOL_PROPERTY(pmtudisc, pmtudisc, RO),
