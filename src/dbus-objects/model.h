...
extern ni_dbus_service_t	ni_objectmodel_vxlan_service;
extern ni_dbus_service_t	ni_objectmodel_vxlan_factory_service;
...
extern dbus_bool_t		ni_objectmodel_get_bonding_port_info(const ni_bonding_port_info_t *,
