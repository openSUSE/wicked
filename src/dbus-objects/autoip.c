 ...
 */
dbus_bool_t
ni_objectmodel_autoip_acquire(ni_interface_t *dev, const ni_addrconf_request_t *req, DBusError *error)
{
 ...
 */
dbus_bool_t
ni_objectmodel_autoip_release(ni_interface_t *dev, const ni_addrconf_lease_t *lease, DBusError *error)
{
	ni_dbus_object_t *object = ni_objectmodel_autoip_wrap_interface(dev);
	dbus_bool_t rv;
