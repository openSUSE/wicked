...
static int		__ni_discover_ipip_tunnel(ni_netdev_t *, struct nlattr **, struct nlattr**);
 ...
 */
static int
__ni_discover_ipip_tunnel(ni_netdev_t *dev, struct nlattr **link_info, struct nlattr **info_data)
{
	ni_tunnel_t *tunnel;
	uint32_t ip;
	uint8_t pmtudisc;
